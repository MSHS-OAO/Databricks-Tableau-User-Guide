...
The Oracle Cloud Wallet is a ZIP archive that contains the SSL certificates, connection descriptors, and credential files needed to establish a secure mTLS connection from any client (Databricks, ODBC, JDBC) to an Oracle Autonomous Database.
