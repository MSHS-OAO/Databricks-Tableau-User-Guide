...
5. Now that tasks have been scheduled, set job settings in the right-hand pane of task view.
    ...
    3. Set up job notifications to trigger a message in the appropriate Teams channel on success and on failure.
    ...
    5. Ensure the job-specific dbt [service principal](../Common%20Definitions.md#databricks-terms) is given `Can Manage Run` permissions.
