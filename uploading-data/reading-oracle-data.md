...
This guide covers how to connect a Databricks notebook to an Oracle database and read data into a Spark DataFrame.

## Prerequisites

- Oracle Cloud Wallet (`.zip`) extracted and placed on the Databricks cluster (see [Wallet Extraction](../oracle-cloud-wallet/wallet-extraction.md))
- DSN configured via ODBC Data Source Administrator (see [DSN Configuration](../oracle-cloud-wallet/dsn-configuration.md))
